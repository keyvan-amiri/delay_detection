...
* All configurations that are used for hyper-parameter optimization and training are collected [here](https://github.com/keyvan-amiri/delay_detection/tree/main/cfg). You need to adjust cdg.data.path in the cfg file in order to determine the path to the XES or CSV file.
