...
def get_hpo_params(args):
    ...
    if args.LDS:
        ...
        lds_ks_sp = {"name": "lds_ks", "type": "fixed", "value": 5, "value_type": "int"}
        lds_sigma_sp = {"name": "lds_sigma", "type": "fixed", "value": 2, "value_type": "int"}
        lds_kernel_sp = {"name": "lds_kernel", "type": "fixed",
                         "value": "gaussian", "value_type": "str"}
    # FDS params 
    if args.FDS:
        ...
        fds_ks_sp = {"name": "fds_ks", "type": "fixed", "value": 5, "value_type": "int"}
        fds_sigma_sp = {"name": "fds_sigma", "type": "fixed", "value": 2, "value_type": "int"}
        fds_kernel_sp = {"name": "fds_kernel", "type": "fixed",
                         "value": "gaussian", "value_type": "str"}    
    params = [lr_sp, weight_sp, loss_sp, beta_sp, gamma_sp, ext_sp, asym_sp,
